      ...
      <Container>
        <div className="mx-auto max-w-2xl md:text-center">
          ...
          <p className="mt-4 text-lg tracking-tight text-slate-700">
            Our bakery smells so much like home that people can’t help but fall in love
            with it. Maintaining health is easy when you just skip tons of
            superficial unnecessary ingredients.
          </p>
        </div>
        <ul
          role="list"
